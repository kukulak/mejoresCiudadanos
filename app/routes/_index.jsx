  ...
  return (
    <>
      ...
      <div className=" min-h-screen flex items-center flex-col gap-3 py-10 pt-10 sm:pt-28">
        <section className=" w-full sm:w-3/5 md:w-11/12 lg:w-1/2 xl:w-7/12  flex-wrap sm:flex-nowrap  flex flex-row gap-4 items-start justify-center">
            ...
            <div className="hidden sm:flex flex-col animate-placa rounded-xl bg-light p-7">
              ...
              <div className="  my-5 flex flex-wrap flex-row gap-2">
                {placas?.slice(0, 8).map(item => (
                  <Link
                    className="bg-dark w-[82px] text-[.74rem]  text-light min-h-8 flex justify-center items-center rounded-sm select-none pt-3 pb-2"
                    to={`/placa/${item}`}
                    key={item}
                  >
                    {[
